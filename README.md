...
In terms of meeting my goals, I think I succeeded. While I can be a nitpicky on some of the design decisions, I think that the overall atmosphere and theme was executed to a fairly well degree; while not a perfect one to one representation of what I thought of in my head, it's a representation that I am satisfied with. In terms of the code and implementation, I think I succeeded in how I was able to excercise my skills in front-end development; it's not exactly my forte but I really think this experience working with React and TailwindCSS has improved my skills not only in front-end but as a web developer. It was nice to experiment on hands with CSS and see why sometimes things wouldn't work like I thought they would, but also because of that, I think there might be some janky implementations for some of the aspects that might need to be changed in the future.
