...
export default function ProjectsDialog() {
  return (
    <DialogPanel className="w-[clamp(40em,_60%,_50em)] h-3/4 overflow-y-scroll space-y-4 border bg-white p-12 
        ...
        <hr/>
        <div className="flex flex-col">
        <p className="text-2xl font-bold underline">UVA Course GPA Predictor (ML4VA)</p>
        ...
        <hr className=""/>
        <div className="flex flex-col">
        <p className="text-2xl font-bold underline">The Endless Road</p>
        <a className="italic">July 2024</a>
          <a className="text-sm underline text-blue-400" target="_blank" href="https://youtu.be/5OR1FjGGVHo?si=Su_oBKfyAqTOfTx1">Video</a>
